        ...
        <tr><td align="center">
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; background-color: #ffffff; border: 1px solid #e0e0e0;">
                ...
                <tr><td style="padding: 20px 30px 30px 30px;">
                    ...
                    <p style="color: #333333; line-height: 1.6; margin-bottom: 20px;">Du wurdest eingeladen, dem Unternehmens-Account <b>{{ $tenantName }}</b> auf dem Reisinger Foto Portal beizutreten.</p>
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 20px;">
                        <tr><td align="center">
                            <a href="{{ $inviteLink }}" style="background-color: #2A9D8F; color: #ffffff; padding: 12px 24px; text-decoration: none; font-weight: bold; display: inline-block;">Hier klicken, um den Account zu aktivieren</a>
                        </td></tr>
                    </table>
                </td></tr>
            </table>
