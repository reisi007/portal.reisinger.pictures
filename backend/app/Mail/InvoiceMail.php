...
class InvoiceMail extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        return $this->subject('Ihre Rechnung ' . $this->snapshot->invoice_number)
                    ...
                    ->with(['customBody' => '<p>Guten Tag ' . $this->snapshot->customer_details['name'] . ',</p><p>vielen Dank für Ihre Bestellung im Bild-Portal. Anbei erhalten Sie Ihre Rechnung als PDF-Dokument.</p><p>Ihre Lizenzen und Downloads sind ab sofort in Ihrem Account verfügbar.</p>'])
