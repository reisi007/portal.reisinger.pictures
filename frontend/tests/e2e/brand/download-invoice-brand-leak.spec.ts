...
test.describe('Download Invoice brand-leak (B-01 F2)', () => {
    ...
    test('invoice download endpoint does not 500 on brand-leak code path (B-01 F2)', async ({ request }) => {
    ...
    test('on-page Bankdaten block exposes the resolved brand IBAN (B2B default on dev host)', async ({ page }) => {
