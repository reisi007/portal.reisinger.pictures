...
test.describe('E1: Org-Admin Tenant Overview Visibility', () => {
    ...
    test('Org-Admin sieht Organisation in Übersicht', async ({ page, request }) => {
        ...
        const orgCards = page.locator('main .card').filter({ hasText: tenantName });
