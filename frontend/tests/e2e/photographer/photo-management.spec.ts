...
test.describe('Photo Management Workflow (Flows A, B, K, L, M)', () => {
    ...
    test('Flow B: Photographer can delete a photo from detail view', { tag: ['@feature:photographer:photos'] }, async ({ page }) => {
    ...
    test('Flow A: Photographer grants transient metadata rights via Magic Link, Client edits, Photographer restores', { tag: ['@feature:photographer:photos'] }, async ({ page }) => {
        const auth = new AuthHelper(page);
    ...
    test('Flow K: Expired galleries are crossed out and deny guest access', { tag: ['@feature:photographer:photos'] }, async ({ page }) => {
        const auth = new AuthHelper(page);
        const sidebar = new SidebarHelper(page);
        const modal = new ModalHelper(page);
    ...
    test('Flow L: Invalid magic link does not destroy active user session', { tag: ['@feature:photographer:photos'] }, async ({ page }) => {
        const auth = new AuthHelper(page);
    ...
    test('Flow M: Admin cannot see management buttons or delete photos', { tag: ['@feature:photographer:photos'] }, async ({ page }) => {
        const auth = new AuthHelper(page);
