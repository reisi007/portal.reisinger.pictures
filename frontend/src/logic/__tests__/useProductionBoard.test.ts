...
const mockJobs = {
    photo_jobs: [
        { id: 'j1', status: 'importiert', position: 0, owner, assignee: null, created_at: '2026-08-02T10:00:00Z', title: 'Hochzeit Müller', lightroom_catalog: '2026-08', lightroom_catalog_is_mine: true, total_count: 1200, selected_count: 400, target_gallery_id: null },
    ],
};
