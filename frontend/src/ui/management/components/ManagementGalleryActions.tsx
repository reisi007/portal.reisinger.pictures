        ...
        <div className="flex flex-wrap gap-4 items-center">
            ...
            {isPhotographer && (
                <div className="flex gap-2">
                    ...
                    {gallery.type === 'delivery' && onOpenAIBatchEdit && <button onClick={onOpenAIBatchEdit} className="btn btn-outline btn-sm"><span className="iconify mdi--robot-outline"></span> KI Beschriftung</button>}
