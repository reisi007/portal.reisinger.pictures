...
export default function LicenseSettingsCard() {
    ...
    if (isLoading) return <div className="card bg-base-200 border border-base-300 p-10 flex items-center justify-center min-h-[300px]"><span className="loading loading-spinner text-primary"></span></div>;
            ...
            <div className="card-body">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-base-100 p-4 rounded-box border border-base-300 shadow-inner">
                        ...
                        <div className="text-sm">Original + Kommerziell + Unbegrenzt + Weltweit: <strong className="font-mono text-primary">{calculateUpgradePrice('none', 'original', 'commercial', 'unlimited', 'international').toFixed(2)} €</strong></div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="col-span-full font-bold border-b border-base-300 pb-2 mt-4 text-primary">Verbreitungsraum (Gebiet)</div>
                        <div className="form-control"><label className="label"><span className="label-text font-bold">National (Inland)</span></label><textarea {...register('term_territory_national')} className="textarea textarea-bordered h-20"/></div>
                        <div className="form-control"><label className="label"><span className="label-text font-bold">International (Weltweit)</span></label><textarea {...register('term_territory_international')} className="textarea textarea-bordered h-20"/></div>
