...
export default function AdminWatermarkBanner() {
    ...
    return (
        <div className="bg-warning text-warning-content p-2 md:p-3 text-center text-sm font-bold flex flex-wrap justify-center items-center gap-2 z-[60] shrink-0 shadow-md">
            ...
            <Link to="/settings" className="underline whitespace-nowrap bg-base-100/20 px-2 py-1 rounded hover:bg-base-100/40 transition-colors">Jetzt beheben</Link>
        </div>
    );
}
