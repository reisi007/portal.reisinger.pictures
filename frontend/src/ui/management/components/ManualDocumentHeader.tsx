            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="form-control">
                    <label className="label"><span
                        className="label-text font-bold">{isOffer ? 'Angebotsdatum' : 'Rechnungsdatum'}</span></label>
                    <input required type="date" value={data.date} onChange={e => onUpdate('date', e.target.value)}
                ...
                <div className="form-control lg:col-span-2">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 w-full">
                        ...
                        {dueDateOption !== 'custom' ? (
                            <div
                                className="input input-bordered bg-base-200 opacity-70 flex items-center overflow-hidden whitespace-nowrap"
                                title={data.due_date}>{data.due_date}</div>
                        ) : (
