...
export default function WatermarkSettingsCard() {
    ...
    const watchScale = watermarkForm.watch('scale', 0.1);
    const watchOpacity = watermarkForm.watch('opacity', 0.6);
    ...
    return (
        <div className="card bg-base-200 border border-base-300">
            <div className="card-body">
                ...
                <form onSubmit={watermarkForm.handleSubmit(onSubmit)} className="space-y-6">
                    <div className="form-control w-full">
                        <label className="label"><span className="label-text font-bold">Logo (nur .svg)</span></label>
                        <input 
                            type="file" 
                            accept=".svg" 
                            {...watermarkForm.register('svg')} 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="form-control">
                            ...
                            <input 
                                ...
                                {...watermarkForm.register('opacity')} 
                                className="range range-primary"
                            />
                        ...
                        <div className="form-control">
                            ...
                            <select {...watermarkForm.register('position')} className="select select-bordered w-full">
                    ...
                    <div className="mt-6">
                        <button type="submit" disabled={watermarkForm.formState.isSubmitting} className="btn btn-primary">
                            {watermarkForm.formState.isSubmitting ? <span className="loading loading-spinner"></span> : 'Speichern & Cache leeren'}
                        </button>
                    </div>
                </form>
            </div>
