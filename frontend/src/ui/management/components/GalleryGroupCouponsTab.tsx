        ...
        <div>
            <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
                <div className="text-sm opacity-70">
                    {coupons.length === 0
                        ? 'Keine Coupons für diese Galerie-Gruppe.'
                        : `${coupons.length} Coupon${coupons.length === 1 ? '' : 's'} für diese Galerie-Gruppe`}
                </div>
                        ...
                        {coupons.length === 0 && (
                            <tr>
                                <td colSpan={6} className="text-center py-10 opacity-50">
                                    Keine Coupons für diese Galerie-Gruppe vorhanden.
                                </td>
                            </tr>
                        )}
                    </tbody>
