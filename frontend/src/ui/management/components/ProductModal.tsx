            ...
            <div className="modal-box relative">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="form-control">
                        ...
                        <input required type="text" {...register('name')} className="input input-bordered" />
                    </div>
                    <div className="form-control">
                    ...
                    <div className="form-control w-1/2">
                        ...
                        <input required type="number" step="any" min="0" {...register('price', { valueAsNumber: true })} className="input input-bordered font-mono" />
                    </div>
